...
::: {.box .b}
```{r forest_plot_guadalajara, dpi = 300, fig.height= 5,fig.width = 7,fig.align = "center", out.height='100%', out.width = '100%',fig.show = "hold"}
...
::: {.box .c}
```{r power_law_plot_guadalajara,dpi = 300, warning=FALSE, fig.align = "center", out.width = '100%',out.height='100%',fig.show = "hold"}
...
::: {.box .d}
```{r gauge_blocks_guadalajara,fig.align = "center", out.height='90%', out.width = '90%'}
...
::: {.box .b}
```{r forest_plot_vallarta, dpi = 300, fig.height= 5,fig.width = 7,fig.align = "center", out.height='100%', out.width = '100%',fig.show = "hold"}
...
::: {.box .c}
```{r power_law_plot_vallarta,dpi = 300, warning=FALSE, fig.align = "center", out.width = '100%',out.height='100%',fig.show = "hold"}
# Step 7. make the function por calculate the cumulative ####
funcumsum <- function(x){
    x$cumulative_n <- cumsum(x$n_cases)
    x$perc_cumsum_n <- round((cumsum(x$n_cases)/sum(x$n_cases))*100, digits = 1)
...
::: {.box .d}
```{r gauge_blocks_vallarta,fig.align = "center", out.height='90%', out.width = '90%'}
y_hot <- hotspots |> dplyr::filter(hotspots_gi == 1)
centroid <- rgeomex::blocks_ine20_mx_centroid |>
  sf::st_as_sf(coords = c("x", "y"), crs = 4326)
b_loc <- centroid[hotspots, ]
...
::: {.box .e}
```{r gauge_AGEB_vallarta, fig.align = "center", out.height='90%', out.width = '90%'}
...
::: {.box .f}
```{r gauge_casos_vallarta, out.height='90%', out.width = '90%', fig.align = "center"}
...
::: wrapper
::: {.box .a}
```{r hotspots_dengue_cd_guzman}
# Step 1. extract the locality ####
loc <- rgeomex::extract_locality(cve_edo = "14", 
                                 locality = "Ciudad Guzmán")
...
::: {.box .b}
```{r forest_plot_guzman, dpi = 300, fig.height= 5,fig.width = 7,fig.align = "center", out.height='100%', out.width = '100%',fig.show = "hold"}
...
::: {.box .c}
```{r power_law_plot_cd_guzman,dpi = 300, warning=FALSE, fig.align = "center", out.width = '100%',out.height='100%',fig.show = "hold"}
# Step 7. make the function por calculate the cumulative ####
funcumsum <- function(x){
    x$cumulative_n <- cumsum(x$n_cases)
    x$perc_cumsum_n <- round((cumsum(x$n_cases)/sum(x$n_cases))*100, digits = 1)
...
::: {.box .d}
```{r gauge_blocks_cd_guzman,fig.align = "center", out.height='90%', out.width = '90%'}
y_hot <- hotspots |> dplyr::filter(hotspots_gi == 1)
centroid <- rgeomex::blocks_ine20_mx_centroid |>
  sf::st_as_sf(coords = c("x", "y"), crs = 4326)
b_loc <- centroid[hotspots, ]
...
::: {.box .e}
```{r gauge_AGEB_cd_guzman, fig.align = "center", out.height='90%', out.width = '90%'}
...
::: {.box .f}
```{r gauge_casos_cd_guzman, out.height='90%', out.width = '90%', fig.align = "center"}
...
### [**Autlán de Navarro**]{style="color:#990000"}
...
::: {.box .b}
```{r forest_plot_autlan, dpi = 300, fig.height= 5,fig.width = 7,fig.align = "center", out.height='100%', out.width = '100%',fig.show = "hold"}
...
::: {.box .c}
```{r power_law_plot_autlan,dpi = 300, warning=FALSE, fig.align = "center", out.width = '100%',out.height='100%',fig.show = "hold"}
# Step 7. make the function por calculate the cumulative ####
funcumsum <- function(x){
    x$cumulative_n <- cumsum(x$n_cases)
    x$perc_cumsum_n <- round((cumsum(x$n_cases)/sum(x$n_cases))*100, digits = 1)
...
::: {.box .d}
```{r gauge_blocks_autlan,fig.align = "center", out.height='90%', out.width = '90%'}
y_hot <- hotspots |> dplyr::filter(hotspots_gi == 1)
centroid <- rgeomex::blocks_ine20_mx_centroid |>
  sf::st_as_sf(coords = c("x", "y"), crs = 4326)
b_loc <- centroid[hotspots, ]
...
::: {.box .e}
```{r gauge_AGEB_autlan, fig.align = "center", out.height='90%', out.width = '90%'}
...
::: {.box .f}
```{r gauge_casos_autlan, out.height='90%', out.width = '90%', fig.align = "center"}
...
::: {.box .b}
```{r forest_plot_cihuatlan, dpi = 300, fig.height= 5,fig.width = 7,fig.align = "center", out.height='100%', out.width = '100%',fig.show = "hold"}
...
::: {.box .c}
```{r power_law_plot_cihuatlan,dpi = 300, warning=FALSE, fig.align = "center", out.width = '100%',out.height='100%',fig.show = "hold"}
# Step 7. make the function por calculate the cumulative ####
funcumsum <- function(x){
    x$cumulative_n <- cumsum(x$n_cases)
    x$perc_cumsum_n <- round((cumsum(x$n_cases)/sum(x$n_cases))*100, digits = 1)
...
::: {.box .d}
```{r gauge_blocks_cihuatlan,fig.align = "center", out.height='90%', out.width = '90%'}
y_hot <- hotspots |> dplyr::filter(hotspots_gi == 1)
centroid <- rgeomex::blocks_ine20_mx_centroid |>
  sf::st_as_sf(coords = c("x", "y"), crs = 4326)
b_loc <- centroid[hotspots, ]
...
::: {.box .e}
```{r gauge_AGEB_cihuatlan, fig.align = "center", out.height='90%', out.width = '90%'}
...
::: {.box .f}
```{r gauge_casos_cihuatlan, out.height='90%', out.width = '90%', fig.align = "center"}
...
```{r vector_hotspots_cd_guzman, dpi = 300, warning=FALSE, message=FALSE}
deneggs::map_eggs_hotspots(betas = denmex::eggs_betas_14_jalisco,
